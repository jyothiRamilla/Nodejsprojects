...
curl -s -X POST \
  ...
  -H "authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1ODQ0MDQ4NTUsInVzZXJuYW1lIjoiSmltIiwib3JnTmFtZSI6Ik9yZzEiLCJpYXQiOjE1ODQzNjg4NTV9.JrIPBkjoLTd8QmRBxrAi-d5xm8nC72CJD8Eo5BLm80I" \
  -H "content-type: application/json" \
  -d '{
...
curl -s -X GET \
  "http://localhost:4000/channels/mychannel/blocks?hash=4f8caee98fe6a68ddf4f86024719ec47fb213723f4142c173e5d3e7237776225&peer=peer0.org1.example.com" \
  -H "authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1ODQ0MjU3OTgsInVzZXJuYW1lIjoiSmltIiwib3JnTmFtZSI6Ik9yZzEiLCJpYXQiOjE1ODQzODk3OTh9.rXDrGcZfg5KC4lb-LCSTMJnlAaKjZoLKYp-ge-7-YUo" \
...
```
curl -s -X GET http://localhost:4000/channels/mychannel/transactions/6e6626a3c1debe6574d4824c2de83e145cba7b04371502dfc4bb5c50bdf8c2b3?peer=peer0.org1.example.com \
  -H "authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1ODQ0MDQ4NTUsInVzZXJuYW1lIjoiSmltIiwib3JnTmFtZSI6Ik9yZzEiLCJpYXQiOjE1ODQzNjg4NTV9.JrIPBkjoLTd8QmRBxrAi-d5xm8nC72CJD8Eo5BLm80I" \
  -H "content-type: application/json"
```
